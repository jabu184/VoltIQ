    ...
    try {
      if (isManualMode) {
        ...
        if (serverHealth) {
          ...
          const serverVin = serverData?.vehicle?.vin || (activeVehicle.vin !== 'veh_default' ? activeVehicle.vin : undefined);
          const serverSnaps = await fetchServerSnapshots(2000, serverVin);
